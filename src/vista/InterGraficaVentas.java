...
public class InterGraficaVentas extends javax.swing.JInternalFrame {
    ...
    private int MetodoContador() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "SELECT fechaVenta, COUNT(fechaVenta) AS Ventas FROM cabecera_venta WHERE fechaVenta BETWEEN '" + InterGraficas.fecha_inicio + "' AND '" + InterGraficas.fecha_fin + "'GROUP BY fechaVenta;");
    ...
    // Metodo para determninar cual es el dia de mayor ventas
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 0, 300, -1));
