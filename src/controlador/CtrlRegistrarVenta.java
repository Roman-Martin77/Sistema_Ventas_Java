...
public class CtrlRegistrarVenta {
    ...
    // Último id de cabecera de venta
    ...
    //Metodo para guardar la cabecera de venta
      ...
      //Metodo para guardar el detalle de venta
        ...
        Connection cn = Conexion.conectar();
        try {
            PreparedStatement consulta = cn.prepareStatement("INSERT INTO detalle_venta ( idDetalleVenta, idCabeceraVenta, idProducto, cantidad, precioUnitario, subtotal, descuento, iva, totalPagar, estado) VALUES (?,?,?,?,?,?,?,?,?,?)");
    ...
    try {
        ...
        PreparedStatement consulta = cn.prepareStatement("UPDATE cabecera_venta SET IdCliente = ?, estado = ?"
